    ...
    render() {
        ...
        return (
            <div className="sidebar">
                <img src={logo} />
                <h1><Link smooth to="/#start" className="h1_links">Rivando Pondaag</Link></h1>
                <p style={{color:'black',fontWeight:'bold'}} className="gmail"> r_pondaag@gmail.com </p>
                ...
                <div className="flip-card-back">
                    <ul className="sidebar-nav">
                        ...
                        <li className="sidebar-nav-icons"> <a href="#" rel="opener noreferrer" target="_blank" class="fa fas fa-github fa-lg"></a></li>
